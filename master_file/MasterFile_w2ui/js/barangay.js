...
$(function () {    
    $('#grid').w2grid({ 
        ...
        columns: [                
            ...
            { field: 'lname', caption: 'Barangay Code', size: '30%', sortable: true },
            { field: 'fname', caption: 'Barangay Name', size: '30%', sortable: true },
            { field: 'email', caption: 'Barangay Status', size: '40%' },
